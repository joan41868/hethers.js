...
describe("Test Hedera Provider Formatters", function () {
    ...
    it('Should parse hedera record to hethers response', async function () {
        ...
        assert.strictEqual(transactionResponse.transactionId, hederaTransactionRecord.transaction.transaction_id);
        ...
        assert.strictEqual(transactionResponse.customData.result, hederaTransactionRecord.transaction.result);
    }).timeout(timeout * 4);
