...
var hederaPreviewnetOperableAccount = {
    "operator": {
        "accountId": "0.0.1340",
...
describe("Test Hedera Provider", function () {
    ...
    it('should submit signed transaction', function () {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, tx, txBytes, signedTx, provider, txResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        privateKey = sdk_1.PrivateKey.fromString(hederaPreviewnetOperableAccount.operator.privateKey);
                        return [4 /*yield*/, new sdk_1.ContractCreateTransaction()
                                ...
                                .setTransactionId(sdk_1.TransactionId.generate(hederaPreviewnetOperableAccount.operator.accountId))
                                .freeze()
                                .sign(privateKey)];
                    case 1:
                        tx = _a.sent();
                    ...
                    case 2:
                        txResponse = _a.sent();
                        assert_1.default.strictEqual(txResponse.gasLimit.toNumber(), 1000);
                        assert_1.default.strictEqual(txResponse.from, (0, utils_1.getAddressFromAccount)(hederaPreviewnetOperableAccount.operator.accountId));
                        assert_1.default.strictEqual(txResponse.to, undefined); // contract create TX should not be addressed to anything
                        assert_1.default.strictEqual(txResponse.value.toNumber(), 100000000000);
                        return [2 /*return*/];
                }
            });
        });
