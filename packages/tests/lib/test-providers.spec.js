...
describe("Extra tests", function () {
    xit("etherscan long-request #1093", function () {
...
describe("Test Hedera Provider", function () {
    ...
    it.only("Get contract code", function () {
        return __awaiter(this, void 0, void 0, function () {
            var contractAccountConfig, contractAddress, nonExistingAddress, defaultProvider, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        nonExistingAddress = "0x0000000000000000000000000000000000000000";
                        defaultProvider = ethers_1.ethers.providers.getDefaultProvider(default_hedera_provider_1.HederaNetworks.TESTNET);
                        return [4 /*yield*/, defaultProvider.getCode(contractAddress)];
                    case 1:
                        result = _a.sent();
                        assert_1.default.strict((typeof result === "string" && result != "0x"), "returns code as string for existing contract - " + contractAddress);
                        return [4 /*yield*/, defaultProvider.getCode(solAddr)];
                    case 2:
                        result = _a.sent();
                        assert_1.default.strictEqual(result, "0x", "returns 0x string for account - " + solAddr);
                        return [4 /*yield*/, defaultProvider.getCode(nonExistingAddress)];
                    case 3:
                        result = _a.sent();
                        assert_1.default.strictEqual(result, "0x", "returns 0x string for non existing account - " + nonExistingAddress);
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, defaultProvider.getCode('0x0000000000000000000000000000000000000000', true)];
                    case 5:
                        result = _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
                        error_2 = _a.sent();
                        assert_1.default.strictEqual(true, error_2.toString().includes("bad result from backend"), "on demand throws backend error");
                        return [3 /*break*/, 7];
