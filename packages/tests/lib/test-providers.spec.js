    ...
    it('Should parse hedera record to hethers response', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                assert_1.default.strictEqual(transactionResponse.transactionId, hederaTransactionRecord.transaction.transaction_id);
                ...
                assert_1.default.strictEqual(transactionResponse.customData.result, hederaTransactionRecord.transaction.result);
                return [2 /*return*/];
            });
        });
    }).timeout(timeout * 4);
