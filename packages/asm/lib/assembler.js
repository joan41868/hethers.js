...
var logger = new hethers_1.hethers.utils.Logger(_version_1.version);
var Guard = {};
function hexConcat(values) {
    return hethers_1.hethers.utils.hexlify(hethers_1.hethers.utils.concat(values.map(function (v) {
        if (v instanceof opcodes_1.Opcode) {
            return [v.value];
        }
        if (typeof (v) === "number") {
            if (v >= 0 && v <= 255 && !(v % 1)) {
                return hethers_1.hethers.utils.hexlify(v);
            }
            else {
...
var Script = /** @class */ (function () {
    function Script(filename, callback) {
        hethers_1.hethers.utils.defineReadOnly(this, "filename", filename);
        hethers_1.hethers.utils.defineReadOnly(this, "contextObject", this._baseContext(callback));
        hethers_1.hethers.utils.defineReadOnly(this, "context", vm_1.default.createContext(this.contextObject));
    }
    Script.prototype._baseContext = function (callback) {
        ...
        return new Proxy({
            ...
            hethers: hethers_1.hethers,
            utils: hethers_1.hethers.utils,
            BigNumber: hethers_1.hethers.BigNumber,
            arrayify: hethers_1.hethers.utils.arrayify,
            concat: hexConcat,
            hexlify: hethers_1.hethers.utils.hexlify,
            zeroPad: function (value, length) {
                return hethers_1.hethers.utils.hexlify(hethers_1.hethers.utils.zeroPad(value, length));
            },
            ...
            randomBytes: function (length) {
                return hethers_1.hethers.utils.hexlify(hethers_1.hethers.utils.randomBytes(length));
            },
            toUtf8Bytes: hethers_1.hethers.utils.toUtf8Bytes,
            toUtf8String: hethers_1.hethers.utils.toUtf8String,
            formatBytes32String: hethers_1.hethers.utils.formatBytes32String,
            parseBytes32String: hethers_1.hethers.utils.parseBytes32String,
            Opcode: opcodes_1.Opcode,
            sighash: function (signature) {
                return hethers_1.hethers.utils.id(hethers_1.hethers.utils.FunctionFragment.from(signature).format()).substring(0, 10);
            },
            topichash: function (signature) {
                return hethers_1.hethers.utils.id(hethers_1.hethers.utils.EventFragment.from(signature).format());
            },
            assemble: assemble,
...
var Node = /** @class */ (function () {
    function Node(guard, location, options) {
        ...
        hethers_1.hethers.utils.defineReadOnly(this, "location", Object.freeze(location));
        hethers_1.hethers.utils.defineReadOnly(this, "tag", "node-" + nextTag++ + "-" + this.constructor.name);
        for (var key in options) {
            hethers_1.hethers.utils.defineReadOnly(this, key, options[key]);
        }
    }
...
var ValueNode = /** @class */ (function (_super) {
    ...
    ValueNode.prototype.getPushLiteral = function (value) {
        ...
        var hex = hethers_1.hethers.utils.hexlify(value);
        if (hex === "0x") {
            throwError("invalid literal: 0x", this.location);
        }
        // Make sure it will fit into a push
        var length = hethers_1.hethers.utils.hexDataLength(hex);
            ...
            return __generator(this, function (_a) {
                ...
                if (this.verbatim) {
                    if (this.value.substring(0, 2) === "0x") {
                        ...
                        visit(this, hethers_1.hethers.BigNumber.from(this.value).toHexString());
                    }
                }
                else {
                    visit(this, this.getPushLiteral(hethers_1.hethers.BigNumber.from(this.value)));
                }
                assembler.end(this);
                return [2 /*return*/];
            });
                ...
                if (isOffset && assembler.positionIndependentCode) {
                    ...
                    if (here > value) {
                        ...
                        for (w = 1; w <= 5; w++) {
                            ...
                            if (hethers_1.hethers.utils.hexDataLength(literal) <= w) {
                                literal = hethers_1.hethers.utils.hexZeroPad(literal, w);
                                break;
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Append this opcode
                        visit(this, hethers_1.hethers.utils.hexlify(this.opcode.value));
                        assembler.end(this);
                        return [2 /*return*/];
                }
            });
...
var LabelledNode = /** @class */ (function (_super) {
    ...
    function LabelledNode(guard, location, name, values) {
        ...
        values = hethers_1.hethers.utils.shallowCopy(values || {});
        values.name = name;
...
var LabelNode = /** @class */ (function (_super) {
    ...
    LabelNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assembler.start(this);
                visit(this, hethers_1.hethers.utils.hexlify(opcodes_1.Opcode.from("JUMPDEST").value));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
    ...
    PaddingNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                padding.fill(0);
                visit(this, hethers_1.hethers.utils.hexlify(padding));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data) {
        ...
        hethers_1.hethers.utils.defineReadOnly(_this, "padding", new PaddingNode(Guard, _this.location));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        bytecode = hethers_1.hethers.utils.concat(this.data.map(function (d) { return assembler.getBytecode(d); }));
                        i = 0;
                    ...
                    case 1:
                        ...
                        if (this.verbatim) {
                            if (typeof (result) === "number") {
                                visit(this, hethers_1.hethers.BigNumber.from(result).toHexString());
                            }
                            else {
                                visit(this, hethers_1.hethers.utils.hexlify(result));
                            }
                        }
                        else {
...
function disassemble(bytecode) {
    var ops = [];
    var offsets = {};
    var bytes = hethers_1.hethers.utils.arrayify(bytecode, { allowMissingPrefix: true });
    var i = 0;
    var oob = false;
    while (i < bytes.length) {
        var opcode = opcodes_1.Opcode.from(bytes[i]);
        if (!opcode) {
            opcode = new opcodes_1.Opcode("unknown (" + hethers_1.hethers.utils.hexlify(bytes[i]) + ")", bytes[i], 0, 0);
        }
        ...
        if (push) {
            var data = hethers_1.hethers.utils.hexlify(bytes.slice(i, i + push));
            if (hethers_1.hethers.utils.hexDataLength(data) === push) {
                op.pushValue = data;
                op.length += push;
                i += push;
            }
    ...
    ops.getBytes = function (offset, length) {
        ...
        return hethers_1.hethers.utils.arrayify(result);
    };
...
function formatBytecode(bytecode) {
    ...
    bytecode.forEach(function (op) {
        ...
        var offset = hethers_1.hethers.utils.hexZeroPad(hethers_1.hethers.utils.hexlify(op.offset), 2);
...
var Assembler = /** @class */ (function () {
    function Assembler(root, positionIndependentCode) {
        hethers_1.hethers.utils.defineReadOnly(this, "root", root);
        hethers_1.hethers.utils.defineReadOnly(this, "positionIndependentCode", !!positionIndependentCode);
        var nodes = {};
        var labels = {};
        var parents = {};
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), hethers_1.hethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), hethers_1.hethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
        ...
        hethers_1.hethers.utils.defineReadOnly(this, "labels", Object.freeze(labels));
        hethers_1.hethers.utils.defineReadOnly(this, "nodes", Object.freeze(nodes));
        hethers_1.hethers.utils.defineReadOnly(this, "_parents", Object.freeze(parents));
    }
    // Link operations
    ...
    Assembler.prototype.getLinkValue = function (target, source) {
        ...
        var bytes = Array.prototype.slice.call(hethers_1.hethers.utils.arrayify(info.bytecode));
        hethers_1.hethers.utils.defineReadOnly(bytes, "ast", target);
        hethers_1.hethers.utils.defineReadOnly(bytes, "source", target.location.source);
        ...
        if (!safeOffset) {
            ...
            hethers_1.hethers.utils.defineReadOnly(bytes, "_freeze", function () { });
        }
        ...
        if (safeOffset) {
            ...
            hethers_1.hethers.utils.defineReadOnly(bytes, "_freeze", function () {
                ...
                frozen_1 = true;
                hethers_1.hethers.utils.defineReadOnly(bytes, "offset", bytes.offset);
            });
        }
        return bytes;
    };
...
var CodeGenerationAssembler = /** @class */ (function (_super) {
    ...
    function CodeGenerationAssembler(root, options) {
        ...
        hethers_1.hethers.utils.defineReadOnly(_this, "retry", ((options.retry != null) ? options.retry : 512));
        hethers_1.hethers.utils.defineReadOnly(_this, "filename", (0, path_1.resolve)(options.filename || "./contract.asm"));
        hethers_1.hethers.utils.defineReadOnly(_this, "defines", Object.freeze(options.defines || {}));
        hethers_1.hethers.utils.defineReadOnly(_this, "_stack", []);
        _this.reset();
        return _this;
    }
        ...
        try {
            if (result.offset < 0) {
                ...
                this._checks.push(function () {
                    ...
                    if (check.offset === result.offset && hethers_1.hethers.utils.hexlify(check) === hethers_1.hethers.utils.hexlify(result)) {
                        return true;
                    }
                    return false;
                });
            ...
            this._checks.push(function () {
                var check = _super.prototype.getLinkValue.call(_this, target, source);
                return (hethers_1.hethers.utils.hexlify(check) === hethers_1.hethers.utils.hexlify(result));
            });
        }
        return result;
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.root.assemble(this, function (node, bytecode) {
                                ...
                                offset += hethers_1.hethers.utils.hexDataLength(bytecode);
                            })];
                    case 1:
                        _a.sent();
                        this._runChecks();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, logger.throwError("unable to assemble; " + this.retry + " attempts failed to generate stable bytecode", hethers_1.hethers.utils.Logger.errors.UNKNOWN_ERROR, {})];
                }
            });
        });
    };
